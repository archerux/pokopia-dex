...
│   ├── logo-pokopia.png        Pokémon Pokopia logo (saved from pokopia.pokemon.com)
│   ├── webclip.png             180×180 iOS home-screen icon — hero crop + logo composite (generated by Pillow)
│   └── favicon.png / .ico      32×32 browser favicon — same source, smaller scale
├── data/
